...
bg4_40323205 = Blueprint('bg4_40323205', __name__, url_prefix='/bg4_40323205', template_folder='templates')




@bg4_40323205.route('/AAAAAAAA')
def AAAAAAAA():
    outstring = '''
<!DOCTYPE html>
<html>
...
# 畫 A
# 左邊兩個垂直單元
x1, y1 = mychain.basic_rot(0, 0, 90, color="white")
x2, y2 = mychain.basic_rot(x1, y1, 90, color="white")
# 左斜邊兩個單元
x3, y3 = mychain.basic_rot(x2, y2, 80, color="white")
x4, y4 = mychain.basic_rot(x3, y3, 71, color="white")
# 最上方水平單元
x5, y5 = mychain.basic_rot(x4, y4, 0, color="white")
# 右斜邊兩個單元
x6, y6 = mychain.basic_rot(x5, y5, -71, color="white")
x7, y7 = mychain.basic_rot(x6, y6, -80, color="white")
# 右邊兩個垂直單元
x8, y8 = mychain.basic_rot(x7, y7, -90, color="white")
x9, y9 = mychain.basic_rot(x8, y8, -90, color="white")
# 中間兩個水平單元
x10, y10 = mychain.basic_rot(x8, y8, -180, color="white")
mychain.basic(x10, y10, x1, y1, color="white")
...
x5, y5 = mychain.basic_rot(x4, y4, 0, color="white")
# 右斜 -30 度
x6, y6 = mychain.basic_rot(x5, y5, -30, color="white")
# 右上垂直向下單元
x7, y7 = mychain.basic_rot(x6, y6, -90, color="white")
# 右斜 240 度
x8, y8 = mychain.basic_rot(x7, y7, 210, color="white")
# 中間水平
mychain.basic(x8, y8, x2, y2, color="white")
# 右下斜 -30 度
x10, y10 = mychain.basic_rot(x8, y8, -30, color="white")
# 右下垂直向下單元
x11, y11 = mychain.basic_rot(x10, y10, -90, color="white")
# 右下斜 240 度
x12, y12 = mychain.basic_rot(x11, y11, 210, color="white")
# 水平接回起點
mychain.basic(x12,y12, 0, 0, color="white")

cgo.setWorldCoords(-50, -250, 500, 500) 

# 畫 A
# 左邊兩個垂直單元
x1, y1 = mychain.basic_rot(50,0, 90, color="white")
x2, y2 = mychain.basic_rot(x1, y1, 90, color="white")
# 左斜邊兩個單元
x3, y3 = mychain.basic_rot(x2, y2, 80, color="white")
x4, y4 = mychain.basic_rot(x3, y3, 71, color="white")
...
# 畫 D
# 左邊四個垂直單元
x1, y1 = mychain.basic_rot(0+60, 0, 90, color="white")
x2, y2 = mychain.basic_rot(x1, y1, 90, color="white")
x3, y3 = mychain.basic_rot(x2, y2, 90, color="white")
x4, y4 = mychain.basic_rot(x3, y3, 90, color="white")
# 上方一個水平單元
...
x7, y7 = mychain.basic_rot(x6, y6, -60, color="white")
# 右中垂直向下單元
x8, y8 = mychain.basic_rot(x7, y7, -90, color="white")
# -120 度
x9, y9 = mychain.basic_rot(x8, y8, -120, color="white")
# -140
x10, y10 = mychain.basic_rot(x9, y9, -140, color="white")
# 水平接回原點
mychain.basic(x10, y10, 0+60, 0, color="white")

# 畫 C
# 上半部
# 左邊中間垂直起點, 圓心位於線段中央, y 方向再向上平移兩個鏈條圓心距單位
x1, y1 = mychain.basic_rot(0+65*2, -10+10+20*math.sin(80*deg)+20*math.sin(30*deg), 90, color="white")
# 上方轉 80 度
x2, y2 = mychain.basic_rot(x1, y1, 80, color="white")
# 上方轉 30 度
x3, y3 = mychain.basic_rot(x2, y2, 30, color="white")
# 上方水平
x4, y4 = mychain.basic_rot(x3, y3, 0, color="white")
# 下半部, 從起點開始 -80 度
x5, y5 = mychain.basic_rot(0+65*2, -10+10+20*math.sin(80*deg)+20*math.sin(30*deg), -80, color="white")
# 下斜 -30 度
x6, y6 = mychain.basic_rot(x5, y5, -30, color="white")
# 下方水平單元
x7, y7 = mychain.basic_rot(x6, y6, -0, color="white")
...
@bg4_40323205.route('/twocircle/<x>/<y>')
@bg4_40323205.route('/twocircle', defaults={'x':0, 'y':0})
def twocircle(x,y):
...
class chain():
    ...
    def __init__(self, fillcolor="white", border=True, strokecolor= "black", linewidth=2, scale=1):
...
'''
    ...
    return outstring
@bg4_40323205.route('/eighteenthirty/<x>/<y>')
@bg4_40323205.route('/eighteenthirty', defaults={'x':0, 'y':0})
