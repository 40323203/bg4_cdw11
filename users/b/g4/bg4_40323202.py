...
class chain():
    ...
    def __init__(self, fillcolor="yellow", border=True, strokecolor= "tan", linewidth=2, scale=1):
...
def task4a():
    return head_str + chain_str + task4a(0, 0) + tail_str

# 傳繪 A 函式內容
def task4a(x, y, scale=1, color="yellow"):
    outstring = '''
